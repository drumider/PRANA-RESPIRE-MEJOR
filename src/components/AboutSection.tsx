  ...
  return (
    <div className="bg-white py-12 sm:py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-20">
        ...
        {/* Upper Block: Image + Vision/Mission (ES & EN) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          {/* Right: Vision & Mission (Spanish & English) */}
        ...
        <div className="space-y-10 text-center pt-8 border-t border-slate-100">
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            ...
            <p className="text-xl sm:text-2xl font-normal text-[#21B5EB] tracking-tight leading-snug">
