...
export const Navbar: React.FC<NavbarProps> = ({ lang, setLang, onOpenBooking }) => {
  ...
  const navLinks = [
    ...
    { path: '/deportistas', label: t.sports },
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-4">
            ...
            <div className="flex items-center bg-slate-100 p-0.5 rounded-full border border-slate-200">
              <button
                type="button"
                onClick={() => setLang('es')}
                className={`px-2.5 py-1 text-[11px] font-bold rounded-full transition-all duration-200 cursor-pointer ${
                  lang === 'es'
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm text-white bg-slate-900 hover:bg-slate-800 active:bg-slate-950 transition-all shadow-md hover:shadow-lg focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 cursor-pointer group"
            >
          ...
          <div className="flex items-center gap-2 xl:hidden">
            <button
              onClick={onOpenBooking}
              className="sm:hidden px-3 py-1.5 rounded-lg font-bold text-xs text-white bg-slate-900 hover:bg-slate-800 cursor-pointer"
            >
              {t.bookAppointment}
            </button>
            <button
